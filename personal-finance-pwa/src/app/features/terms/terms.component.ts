  ...
  template: `
    <div class="min-h-screen bg-background py-10 px-4">
      <div class="max-w-3xl mx-auto bg-card rounded-2xl shadow-sm p-8">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-foreground mb-2">1. Acceptance of Terms</h2>
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-foreground mb-2">2. Description of Service</h2>
          <p class="text-muted-foreground leading-relaxed">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-foreground mb-2">3. User Accounts</h2>
          <p class="text-muted-foreground leading-relaxed">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-foreground mb-2">4. Subscriptions and Payments</h2>
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-foreground mb-2">5. Free Tier</h2>
          <p class="text-muted-foreground leading-relaxed">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-foreground mb-2">6. Acceptable Use</h2>
          <p class="text-muted-foreground leading-relaxed">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-foreground mb-2">7. Data and Backups</h2>
          <p class="text-muted-foreground leading-relaxed">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-foreground mb-2">8. Disclaimer of Warranties</h2>
          <p class="text-muted-foreground leading-relaxed">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-foreground mb-2">9. Limitation of Liability</h2>
          <p class="text-muted-foreground leading-relaxed">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-foreground mb-2">10. Governing Law</h2>
          <p class="text-muted-foreground leading-relaxed">
