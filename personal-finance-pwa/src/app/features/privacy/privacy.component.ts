  ...
  template: `
    <div class="min-h-screen bg-gray-50 py-10 px-4">
      <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm p-8">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-gray-800 mb-2">1. Overview</h2>
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-gray-800 mb-2">2. Data We Collect</h2>
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-gray-800 mb-2">3. How We Use Your Data</h2>
          <ul class="list-disc list-inside text-gray-600 leading-relaxed space-y-1">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-gray-800 mb-2">4. Data Sharing</h2>
          <p class="text-gray-600 leading-relaxed">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-gray-800 mb-2">5. Data Retention</h2>
          <p class="text-gray-600 leading-relaxed">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-gray-800 mb-2">6. Security</h2>
          <p class="text-gray-600 leading-relaxed">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-gray-800 mb-2">8. Children's Privacy</h2>
          <p class="text-gray-600 leading-relaxed">
        ...
        <section class="mb-6">
          <h2 class="text-lg font-semibold text-gray-800 mb-2">9. Changes to This Policy</h2>
          <p class="text-gray-600 leading-relaxed">
