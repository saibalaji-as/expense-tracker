...
@Component({
  ...
  template: `
    <nav class="fixed bottom-0 left-0 right-0 z-30 bg-white border-t border-gray-200 md:hidden">
      <div class="flex justify-around items-center h-16">
        ...
        <a routerLink="/monthly"
          ...
          <span class="text-xs mt-1">Monthly</span>
        </a>
        ...
        <a routerLink="/limits"
          ...
          <span class="text-xs mt-1">Limits</span>
        </a>
  ...
  `,
  styles: [`
    a.active svg { color: #2563eb; }
    a.active span { color: #2563eb; font-weight: 600; }
  `],
